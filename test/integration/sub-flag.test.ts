...
describe("Subduction default integration", () => {
  let tmpDir: string;
  let cleanup: () => void;
  ...
  describe("init (Subduction default)", () => {
    it("should initialize a directory without extra flags", async () => {
    ...
    it("should respect default exclude patterns", async () => {
  ...
  describe("sync after Subduction init", () => {
    it("should sync after default init", async () => {
